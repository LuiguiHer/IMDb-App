...
class HomeFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        firstMovie(movieList())
        showMovies(movieList())
    }

    private fun firstMovie(movieList: List<Movie>){
        val picasso = Picasso.get()
        val movie = movieList[7]
    ...
    private fun movieList(): List<Movie> {
        return listOf(
            Movie("Duna","Duna","Duna","Serie de TV 2022","2022", arrayListOf("Ficcion","Aventura"),
                arrayListOf("Alice Braga","Hemry Madera"),"5.0","Arrakis, también denominado \"Dune\", se ha convertido en el planeta más importante del universo. A su alrededor comienza una gigantesca lucha por el poder que culmina en una guerra interestelar.","https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1TrP258UMWJi9MICqYW3o7q1dQE7wCnYNdq6hooH6LKA6-L20","https://as01.epimg.net/meristation/imagenes/2021/09/21/noticias/1632198001_790832_1632198112_noticia_normal.jpg",null),
